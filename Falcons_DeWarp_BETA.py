...
class CameraWidget (QWidget):
    ...
    def undistort_fisheye_frame(self, frame, camera_matrix, distortion_coefficients):
        ...
        if camera_matrix is not None and distortion_coefficients is not None:
            ...
            # TODO Extra step needed for scaling? -> https://github.com/mesutpiskin/opencv-fisheye-undistortion/blob/master/src/python/fisheye_calibration_undistortion.py
